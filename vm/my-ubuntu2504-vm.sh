...
# Author: [Mr-Grover]
# License: MIT | https://github.com/Mr-Grover/ProxmoxVE/raw/main/LICENSE
...
if whiptail --backtitle "Proxmox VE Helper Scripts" --title "My Ubuntu 25.04 VM" --yesno "This will create a New My Ubuntu 25.04 VM. Proceed?" 10 58; then
  :
else
...
<div align='center'>
  ...
  <span style='margin: 0 10px;'>
    ...
    <a href='https://github.com/Mr-Grover/ProxmoxVE' target='_blank' rel='noopener noreferrer' style='text-decoration: none; color: #00617f;'>GitHub</a>
  </span>
  <span style='margin: 0 10px;'>
    <i class="fa fa-comments fa-fw" style="color: #f5f5f5;"></i>
    <a href='https://github.com/Mr-Grover/ProxmoxVE/discussions' target='_blank' rel='noopener noreferrer' style='text-decoration: none; color: #00617f;'>Discussions</a>
  </span>
  <span style='margin: 0 10px;'>
    <i class="fa fa-exclamation-circle fa-fw" style="color: #f5f5f5;"></i>
    <a href='https://github.com/Mr-Grover/ProxmoxVE/issues' target='_blank' rel='noopener noreferrer' style='text-decoration: none; color: #00617f;'>Issues</a>
  </span>
</div>
EOF
)
...
More info at https://github.com/Mr-Grover/ProxmoxVE/discussions/272 \n"
