...
# upstream   https://github.com/Mr-Grover/ProxmoxVE.git (fetch)
# upstream   https://github.com/Mr-Grover/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/Mr-Grover/ProxmoxVE"
echo ""
