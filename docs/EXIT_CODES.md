...
Official discussion: [GitHub #8126](https://github.com/Mr-Grover/ProxmoxVE/discussions/8126)
...
1. Open an issue on [GitHub](https://github.com/Mr-Grover/ProxmoxVE/issues)
2. Include:
   - Exit code number
   - Error message
   - Steps to reproduce
